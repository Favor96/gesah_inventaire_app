...
class CreerInventaireStockPage extends StatefulWidget {
  const CreerInventaireStockPage({Key? key}) : super(key: key);

  @override
  State<CreerInventaireStockPage> createState() => _CreerInventaireStockPageState();
}

class _CreerInventaireStockPageState extends State<CreerInventaireStockPage> {
