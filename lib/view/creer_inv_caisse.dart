...
class CreerInventaireCaissePage extends StatefulWidget {
  const CreerInventaireCaissePage({Key? key}) : super(key: key);

  @override
  State<CreerInventaireCaissePage> createState() => _CreerInventaireCaissePageState();
}

class _CreerInventaireCaissePageState extends State<CreerInventaireCaissePage> {
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              value: _selectTypeCaisse,
              hint: const Text('Type de caisse', style: TextStyle(
                  fontSize: 16,
                  color: AppTheme.inputText,
                  fontWeight: FontWeight.w600
              ),),
              ...
              items: _TypeDeCaisse.map((String client) {
